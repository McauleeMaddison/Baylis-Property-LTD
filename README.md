# Baylis-Property-LTD
Web base application for Landlords to organise repairs and schedule cleaning with a secure login for landlords and a separate Login for the residents
...
* Create or join groups (e.g., Gardening Club, Study Buddies)
